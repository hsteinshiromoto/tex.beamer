...
\iftoggle{futura}{%
	...
	\usepackage{xltxtra} 
		...
		\setmainfont[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Futura LT Medium}
		%\setmonofont[Mapping=tex-text,Scale=MatchLowercase]{DejaVu Sans Mono}
	
		\newfontfamily{\custom_font}[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Futura LT Medium}
		\newfontfamily{\custom_font_light}[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Futura LT Light}
...
\iftoggle{futura}{%
\setbeamerfont{title page}{family={\custom_font}}
}{}
...
\iftoggle{futura}{%
\setbeamerfont{frametitle}{family={\custom_font}}
}{}

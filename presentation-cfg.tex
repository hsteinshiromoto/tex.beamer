...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LOADING FONTS FOR XELATEX COMPILATION
%
...
\iftoggle{futura}{%
	...
	% Download Futura first

    \usefonttheme{serif}  %Necessary to use with Helvetica and Futura
	\usepackage{fontspec}
	\usepackage{xunicode}
	\usepackage{xltxtra} 
		\defaultfontfeatures{Mapping=tex-text,Ligatures={TeX,Common},Scale=MatchLowercase,Color=textcolor}
		\setromanfont[Numbers=OldStyle]{Palatino Linotype} % Preserve this order to have sans serif as main font
		...
		%\newfontfamily{\billy}[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{billy}
}{}

\iftoggle{roboto}{%

	% Download Robot from Google SkyFonts

  \usepackage{fontspec}
  \defaultfontfeatures{Mapping=tex-text}

  \setmainfont[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Roboto}
  
  % Do not add "Numbers=OldStyle" for the options of the fonts below
  \newfontfamily{\normal}[Mapping=tex-text,Scale=MatchLowercase]{Roboto}
  \newfontfamily{\light}[Mapping=tex-text,Scale=MatchLowercase]{Roboto Thin}
  \setmonofont[Mapping=tex-text,Scale=MatchLowercase]{DejaVu Sans Mono}
 
}{}
  % electronic
  \iftoggle{default_font}{%
  \usepackage{fontspec}
  }

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AMS - like packages: must be loaded before the math and fontspec

 \RequirePackage{amsmath}
 \usepackage{mathtools}
 \usepackage{amsfonts,amssymb} % AMS fonts and symbols package
 \usepackage{mathrsfs}
...
\setmonofont[Mapping=tex-text]{DejaVuSansMono.ttf}
\setsansfont[Mapping=tex-text, Color=textcolor,
BoldFont=FuturaLT-Heavy.ttf,
ItalicFont=FuturaLT-Oblique.ttf,
BoldItalicFont=FuturaLT-HeavyOblique.ttf
]
{FuturaLT.ttf}

\newfontfamily\thinfont[]{FuturaLT-Light.ttf}
\newfontfamily\thinitalicfont[]{FuturaLT-LightOblique.ttf}
